...
const Listproduct = () => {
  const [products, setProducts] = useState([]);
    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch('https://backend-server-2.onrender.com/allproducts');
...
const response = await fetch('https://backend-server-2.onrender.com/removeproduct',{
method:'POST',
headers:{
